...
<form action="loginAdministratorServlet" method="post">
  ...
  <div class="container">
    <label for="uname"><b>Administrator</b></label>
    <input type="text" placeholder="Enter Username" name="username" required>

    <label for="psw"><b>Password</b></label>
    <input type="password" placeholder="Enter Password" name="password" required>
        
    <label for="psw"><b>Security key</b></label>
    <input type="password" placeholder="Enter Security Key" name="securitykey" required>    
        
    <button type="submit" value="Login">Login</button>
  </div>

	<a href="loginSupplier.jsp">Login as supplier</a>
